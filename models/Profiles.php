...
class Profiles extends Model
{
    ...
    public $belongsTo = [
		...
		'country' => [Country::class, 'scope' => 'isEnabled'],
		'partner' => [Partners::class, 'key' => 'partner_id']
    ];
    ...
    public function afterSave()
    {
        ...
        $sourcePath = $this->avatar->getLocalPath();
        if ($sourcePath && file_exists($sourcePath)) {
            $this->resizeAvatar($this->avatar, 600);
        }
    }

    protected function resizeAvatar(File $avatar, int $width): void
    {
